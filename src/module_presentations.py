  ...
  ("kaos_political_options", 0, mesh_load_window, [ 
    (ti_on_presentation_load,
      [
        ...
        (create_text_overlay, reg0, "@KAOS: Political Options:", tf_vertical_align_center),
        (position_set_y, pos1, ":headings_y"),
        (overlay_set_position, reg0, pos1),
        ...
        (position_set_y, pos1, ":inputs_y"),
        (create_text_overlay, reg1, "@Dynamic Titles:", tf_center_justify),
        (overlay_set_position, reg1, pos1),
        ...
        (position_set_y, pos1, ":inputs_y"),
        (create_text_overlay, reg1, "@Swadian Tittles:", tf_center_justify),
        (overlay_set_position, reg1, pos1),
       ...
       #(create_combo_label_overlay, "$g_presentation_obj_11"),
        ...
        (overlay_set_position, reg1, pos1),
        (position_set_x, pos1, 350),
        (create_combo_button_overlay, "$g_presentation_obj_23"),
        (overlay_set_position, "$g_presentation_obj_23", pos1),
        (overlay_add_item, "$g_presentation_obj_23", "@Swadian"),
        (overlay_set_val, "$g_presentation_obj_23", 0),
        (overlay_add_item, "$g_presentation_obj_23", "@Vaegirs"),
        (overlay_set_val, "$g_presentation_obj_23", 1),
        (overlay_add_item, "$g_presentation_obj_23", "@Khanate"),
        (overlay_set_val, "$g_presentation_obj_23", 2),
        (overlay_add_item, "$g_presentation_obj_23", "@Nords"),
        (overlay_set_val, "$g_presentation_obj_23", 3),
        (overlay_add_item, "$g_presentation_obj_23", "@Rhodoks"),
        (overlay_set_val, "$g_presentation_obj_23", 4),
        (overlay_add_item, "$g_presentation_obj_23", "@Sultanate"),
        (overlay_set_val, "$g_presentation_obj_23", 5),
        (overlay_add_item, "$g_presentation_obj_23", "@Player"),
        (overlay_set_val, "$g_presentation_obj_23", 6),
        ...
        (create_text_overlay, "$g_presentation_obj_17", "@Claimants Home Town:", tf_center_justify),
        (overlay_set_position, "$g_presentation_obj_17", pos1),
		(overlay_set_tooltip, "$g_presentation_obj_17", "@Toggle to give claimants their home towns eg Lady Isolla of Suno gets Suno when the rebellion starts"),

        (position_set_x, pos1, 350),
		(create_check_box_overlay, "$g_presentation_obj_17", "mesh_checkbox_off", "mesh_checkbox_on"),
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, "$g_presentation_obj_17", pos1),
        (overlay_set_val, "$g_presentation_obj_17", "$kaos_rebellion_home"),
		(val_sub, ":inputs_y", ":cur_y_shift"),
        ...
        (position_set_y, pos1, ":inputs_y"),
        (position_set_x, pos1, 120),
        (create_text_overlay, "$g_presentation_obj_18", "@Civial War:", tf_center_justify),
        (overlay_set_position, "$g_presentation_obj_18", pos1),
		(overlay_set_tooltip, "$g_presentation_obj_18", "@Toggle to allow civial war within factions"),

        (position_set_x, pos1, 350),
		(create_check_box_overlay, "$g_presentation_obj_18", "mesh_checkbox_off", "mesh_checkbox_on"),
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, "$g_presentation_obj_18", pos1),
        (overlay_set_val, "$g_presentation_obj_18", "$kaos_civil_war"),
		(val_sub, ":inputs_y", ":cur_y_shift"),
        ...
        (position_set_y, pos1, ":inputs_y"),
        (position_set_x, pos1, 120),
        (create_text_overlay, "$g_presentation_obj_19", "@Royal Children Titles:", tf_center_justify),
        (overlay_set_position, "$g_presentation_obj_19", pos1),
		(overlay_set_tooltip, "$g_presentation_obj_19", "@Toggle Royal Children titles eg Prince and Princess"),

        (position_set_x, pos1, 350),
		(create_check_box_overlay, "$g_presentation_obj_19", "mesh_checkbox_off", "mesh_checkbox_on"),
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, "$g_presentation_obj_19", pos1),
        (overlay_set_val, "$g_presentation_obj_19", "$kaos_royal_children"),
		(val_sub, ":inputs_y", ":cur_y_shift"),
        ...
        (position_set_y, pos1, ":inputs_y"),
        (position_set_x, pos1, 120),
        (create_text_overlay, "$g_presentation_obj_20", "@Faction Restore:", tf_center_justify),
        (overlay_set_position, "$g_presentation_obj_20", pos1),
		(overlay_set_tooltip, "$g_presentation_obj_20", "@Toggle defeated Faction Restore"),

        (position_set_x, pos1, 350),
		(create_check_box_overlay, "$g_presentation_obj_20", "mesh_checkbox_off", "mesh_checkbox_on"),
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, "$g_presentation_obj_20", pos1),
        (overlay_set_val, "$g_presentation_obj_20", "$kaos_restore"),
		(val_sub, ":inputs_y", ":cur_y_shift"),
        ...
        (position_set_y, pos1, ":inputs_y"),
        (position_set_x, pos1, 120),
        (create_text_overlay, "$g_presentation_obj_21", "@Dynamic King Titles:", tf_center_justify),
        (overlay_set_position, "$g_presentation_obj_21", pos1),
		(overlay_set_tooltip, "$g_presentation_obj_21", "@Toggle Dynamic King Titles depending on faction size"),

        (position_set_x, pos1, 350),
		(create_check_box_overlay, "$g_presentation_obj_21", "mesh_checkbox_off", "mesh_checkbox_on"),
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, "$g_presentation_obj_21", pos1),
        (overlay_set_val, "$g_presentation_obj_21", "$kaos_king_titles"),
		(val_sub, ":inputs_y", ":cur_y_shift"),
        ...
        (position_set_y, pos1, ":inputs_y"),
        (position_set_x, pos1, 120),
        (create_text_overlay, "$g_presentation_obj_24", "@Custom Title:", tf_center_justify),
        (overlay_set_position, "$g_presentation_obj_24", pos1),
		(overlay_set_tooltip, "$g_presentation_obj_24", "@Toggle Custom Titles"),

        (position_set_x, pos1, 350),
		(create_check_box_overlay, "$g_presentation_obj_24", "mesh_checkbox_off", "mesh_checkbox_on"),
        (position_set_y, pos1, ":inputs_y"),
        (overlay_set_position, "$g_presentation_obj_24", pos1),
        (overlay_set_val, "$g_presentation_obj_24", "$kaos_use_custom_title"),
		(val_sub, ":inputs_y", ":cur_y_shift"),
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (else_try),
          	(eq, ":object", "$g_presentation_obj_24"),
            (assign, "$kaos_use_custom_title", ":value"),
